...
import { UsiAutosizeDirective, UsiUtilsModule } from 'usi-campfire/utils';
import { UsiSharedModule } from 'usi-campfire/shared';

import documentation from 'usi-campfire/textarea/documentation/textarea.mdx';
...
export default {
  ...
  decorators: [
    moduleMetadata({
      imports: [UsiSharedModule, UsiUtilsModule, UsiTextareaModule],
