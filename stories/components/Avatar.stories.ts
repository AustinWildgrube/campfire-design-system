...
import documentation from 'usi-campfire/avatar/documentation/avatar.mdx';
...
export default {
  ...
  argTypes: {
    usiAlt: {
      name: 'usiAlt',
      description: 'If an image is used, it is always good practice to add alt text.',
      defaultValue: '',
      type: {
        name: 'string',
        required: false,
    ...
    usiShape: {
      name: 'usiShape',
      description: 'The avatar can either be a circle or square.',
      defaultValue: 'circle',
      type: {
        name: 'string',
        required: false,
