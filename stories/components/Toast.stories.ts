...
import documentation from 'usi-campfire/toast/documentation/toast.mdx';
...
export default {
  ...
  argTypes: {
    ...
    usiId: {
      name: 'usiId',
      description: 'If our toast notifications need an ID, we can assign one, so when we use dispatch events, we know what notification to send it to.',
    ...
    usiLimit: {
      name: 'usiLimit',
      description: 'The maximum number of toast notifications that will appear at once.',
      defaultValue: '4',
      type: {
        name: 'number',
        required: false,
    ...
    usiTimeout: {
      name: 'usiTimeout',
      description: 'How long our toast notification will stay on the screen in milliseconds.',
    ...
    success: {
      name: 'success',
      description: 'Create a toast notification of success type.',
    ...
    warning: {
      name: 'warning',
      description: 'Create a toast notification of warning type.',
      defaultValue: '(options: UsiToast | string) => void',
      type: {
        name: 'string',
        required: false,
    ...
    error: {
      name: 'error',
      description: 'Create a toast notification of error type.',
      defaultValue: '(options: UsiToast | string) => void',
      type: {
        name: 'string',
        required: false,
    ...
    info: {
      name: 'info',
      description: 'Create a toast notification of info type.',
      defaultValue: '(options: UsiToast | string) => void',
      type: {
        name: 'string',
        required: false,
    ...
    default: {
      name: 'default',
      description: 'Create a toast notification of default type.',
      defaultValue: '(options: UsiToast | string) => void',
      type: {
        name: 'string',
        required: false,
