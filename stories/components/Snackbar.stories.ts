...
import documentation from 'usi-campfire/snackbar/documentation/snackbar.mdx';
...
export default {
  ...
  argTypes: {
    ...
    usiLimit: {
      name: 'usiLimit',
      description: 'The maximum number of snackbar notifications that will appear at once.',
      defaultValue: '4',
      type: {
        name: 'number',
        required: false,
    ...
    usiOnAction: {
      ...
      defaultValue: 'closeSnackbar(id: number) => void',
      type: {
        name: 'string',
        required: false,
      },
      table: {
        category: 'Properties',
        defaultValue: { summary: 'closeSnackbar(id: number) => void' },
    ...
    usiPosition: {
      name: 'usiPosition',
      description: 'There are seven different positions in which we can place our snackbar notifications.',
    ...
    success: {
      name: 'success',
      description: 'Create a snackbar of success type.',
    ...
    error: {
      name: 'error',
      description: 'Create a snackbar of error type.',
      defaultValue: '(options: UsiSnackbar | string) => void',
      type: {
        name: 'string',
        required: false,
    ...
    info: {
      name: 'info',
      description: 'Create a snackbar of info type.',
      defaultValue: '(options: UsiSnackbar | string) => void',
      type: {
        name: 'string',
        required: false,
    ...
    default: {
      name: 'default',
      description: 'Create a snackbar of default type.',
      defaultValue: '(options: UsiSnackbar | string) => void',
      type: {
        name: 'string',
        required: false,
...
const Template: Story<UsiSnackbarComponent> = (args: UsiSnackbarComponent) => ({
  props: args,
  template: `<usi-snackbar [snackbar]="snackbar"></usi-snackbar>`,
});
