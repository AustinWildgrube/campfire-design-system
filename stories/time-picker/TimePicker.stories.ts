...
import documentation from '../../projects/campfire/time-picker/documentation/time-picker.mdx';
...
export default {
  ...
  argTypes: {
    ...
    usiEnd: {
      name: 'usiEnd',
      description: 'The maximum allowed time in twenty-four hour format.',
      defaultValue: '23:59',
      type: {
        name: 'string',
        required: false,
    ...
    usiStart: {
      name: 'usiStart',
      description: 'The minimum allowed time in twenty-four hour format.',
      defaultValue: '00:00',
      type: {
        name: 'string',
        required: false,
