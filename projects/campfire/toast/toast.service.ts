...
import { isFunction, isString, UsiToastInterface } from 'usi-campfire/utils';
...
export class UsiToastService extends UsiNotificationService {
   ...
   * @param { UsiToastInterface | string } options | Individual toast config overrides or a title.
   ...
   * @return
   */
  public default(options: UsiToastInterface | string, message?: string, optionalOptions?: Partial<UsiToastInterface>): number {
   ...
   * @return
   */
  public info(options: UsiToastInterface | string, message?: string, optionalOptions?: Partial<UsiToastInterface>): number {
   ...
   * @return
   */
  public success(options: UsiToastInterface | string, message?: string, optionalOptions?: Partial<UsiToastInterface>): number {
   ...
   * @return
   */
  public error(options: UsiToastInterface | string, message?: string, optionalOptions?: Partial<UsiToastInterface>): number {
   ...
   * @return
   */
  public warning(options: UsiToastInterface | string, message?: string, optionalOptions?: Partial<UsiToastInterface>): number {
   ...
   * @param { UsiToastInterface | string } options | Options the user has defined or a title.
   ...
   * @protected
   */
  protected add(options: UsiToastInterface | string, type: string, message?: string, optionalOptions?: Partial<UsiToastInterface>): number {
    let customToastConfig: UsiToastInterface;
    ...
    if (isString(options) && options !== '' && isString(message) && message != null) {
      customToastConfig = <UsiToastInterface>{
        usiTitle: options.toString(),
        usiMessage: message.toString(),
        ...optionalOptions,
      };
    } else {
      customToastConfig = <UsiToastInterface>options;
    }
    ...
    let toast: UsiToastInterface = <UsiToastInterface>{
