...
# Validation Modals
Validation modals are pop-up windows that appear on top of a web page, blocking all other page content until the user completes an action or closes the modal.
They are commonly used to draw users' attention to important information or actions on a website or application.
