...
export class ComponentPortal<T> {
   ...
   * The origin necessary when the host is outside the Angular application context.
   */
  ...
  public attach(host: BasePortalHost): ComponentRef<any> {
...
export abstract class BasePortalHost {
  ...
  public attach(portal: ComponentPortal<any>) {
