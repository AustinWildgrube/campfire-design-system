...
@Component({
  ...
  `,
  styleUrls: ['./styles/dialog.component.scss', '../modals.scss'],
})
export class UsiDialogModalComponent {
  @Input() dialog: UsiModalConfig | undefined;
   ...
   * @param { UsiModalConfig } dialog | To get the ID of the dialog message to close.
   * @return
   */
  public closeModal(dialog: UsiModalConfig): void {
