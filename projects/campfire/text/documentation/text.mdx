...
## Color
Campfire has a [base color system](https://ux.ungerboeck.com/?path=/story/design-colors--page) that is used for all components. We can use these colors to
...
## Font Size
Campfire has a [font size system](https://ux.ungerboeck.com/?path=/story/design-typography--page) that is used for all text. Different circumstances call for
